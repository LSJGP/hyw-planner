...
using PlannerCreator =
    std::function<std::unique_ptr<Planner>(const hyw_sim::proto::PlannerInputs &)>;
...
hyw_sim::proto::PlannerConfig
DefaultTrajectoryConfig(const hyw_sim::proto::PlannerInputs &inputs) {
  if (inputs.has_trajectory_config()) {
    return inputs.trajectory_config();
  }
  hyw_sim::proto::PlannerConfig cfg;
  cfg.set_horizon_s(3.0);
  cfg.set_point_dt_s(0.1);
  return cfg;
}

int ClosestValidRefIndex(const std::vector<hyw_sim::proto::ReferencePoint> &ref,
                         double x, double y) {
  int best = -1;
  double best_d = 1e300;
...
bool RefTangent(const std::vector<hyw_sim::proto::ReferencePoint> &ref, int i,
                double &tx, double &ty) {
...
int ClosestValidRefIndexFrom(const std::vector<hyw_sim::proto::ReferencePoint> &ref,
...
double RefPathLateralError(const std::vector<hyw_sim::proto::ReferencePoint> &ref,
...
void SimulateOneStep(hyw_sim::proto::VehicleState &ego, double cmd_accel,
...
OBB MakeEgoObb(const hyw_sim::proto::VehicleState &ego, const hyw_sim::proto::VehicleParams &p,
               double inflate = 0.0) {
  OBB ego_box;
...
OBB MakeNpcObbAt(const hyw_sim::proto::NpcSnapshot &n, double t_ahead, double inflate) {
  OBB npc_box;
...
double LeaderLimitedSpeedDwa(const hyw_sim::proto::VehicleState &ego,
...
public:
  explicit ReferenceTrajectoryPlanner(const hyw_sim::proto::PlannerInputs &inputs)
...
private:
  hyw_sim::proto::PlanCommand PlanStep(const hyw_sim::proto::VehicleState &ego,
                              const std::vector<hyw_sim::proto::NpcSnapshot> &npcs,
                              int frame_id) const;
  double ComputeLeaderLimitedSpeed(const hyw_sim::proto::VehicleState &ego,
                                   const std::vector<hyw_sim::proto::NpcSnapshot> &npcs,
...
hyw_sim::proto::PlanCommand ReferenceTrajectoryPlanner::PlanStep(
    const hyw_sim::proto::VehicleState &ego, const std::vector<hyw_sim::proto::NpcSnapshot> &npcs,
    int frame_id) const {
  hyw_sim::proto::PlanCommand cmd;
...
public:
  explicit GoalSeekPlanner(const hyw_sim::proto::PlannerInputs &inputs)
      : goal_(inputs.goal()), desired_speed_mps_(inputs.desired_speed_mps()),
        p_(inputs.ego_vehicle()), traj_cfg_(DefaultTrajectoryConfig(inputs)) {}
...
public:
  explicit LocalDwaPlanner(const hyw_sim::proto::PlannerInputs &inputs)
      : goal_(inputs.goal()), desired_speed_mps_(inputs.desired_speed_mps()),
        reference_points_(inputs.reference_points().begin(),
                          inputs.reference_points().end()),
        p_(inputs.ego_vehicle()), traj_cfg_(DefaultTrajectoryConfig(inputs)) {}
...
LocalDwaPlanner::FallbackPurePursuit(const hyw_sim::proto::VehicleState &ego,
                                     double target_x, double target_y,
                                     double target_speed,
                                     const hyw_sim::proto::RoadContext &road) const {
  hyw_sim::proto::PlanCommand cmd;
...
hyw_sim::proto::PlanCommand
LocalDwaPlanner::PlanStep(const hyw_sim::proto::VehicleState &ego,
                          const std::vector<hyw_sim::proto::NpcSnapshot> &npcs,
                          int frame_id, const hyw_sim::proto::RoadContext &road) const {
...
const bool kRegisteredGoalSeek =
    RegisterPlanner("goal_seek", [](const hyw_sim::proto::PlannerInputs &in) {
